...
CREATE TABLE `diet_analysis` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `diet_analysis_user_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `normal_user` VALUES (10,1,1,1,0,NULL,NULL),(11,1,1,1,0,NULL,NULL),(12,1,1,1,0,NULL,NULL),(13,1,1,1,0,NULL,NULL),(14,1,1,1,0,NULL,NULL),(15,123,123,13,0,NULL,NULL);
...
-- Dump completed on 2024-12-31 18:08:23
