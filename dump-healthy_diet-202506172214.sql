...
INSERT INTO `comment` VALUES (1,16,1,'test','2025-01-03 01:49:33',0);
...
CREATE TABLE `exercise_record` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `exercise_record_ibfk_1` FOREIGN KEY (`exercise_id`) REFERENCES `exercise_item` (`exercise_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `exercise_record_user_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `exercise_record` VALUES (6,'2024-12-31','00:15:00',3,137,14),(7,'2024-12-31','00:02:00',2,7,15);
...
CREATE TABLE `food_record` (
  ...
  KEY `user_id` (`user_id`),
  KEY `food_id` (`food_id`),
  CONSTRAINT `food_record_ibfk_2` FOREIGN KEY (`food_id`) REFERENCES `food_item` (`foodid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `food_record_user_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `food_record` VALUES (8,'2024-12-31 09:18:39',14,68,100,42,0.1,0.6,10.1,1.7,127,1),(9,'2024-12-31 09:46:24',15,113,1121231,2197612,209670.197,77364.939,0,1303991.653,493341.64,0),(10,'2024-12-31 09:47:58',15,101,333333333,2143333331,194999999.805,46999999.953,71333333.262,9999999.99,2039999997.96,41333333.292),(11,'2024-12-31 09:49:15',15,192,2e107,2147483647,1.02e106,1.66e106,1.1720000000000001e107,4.608e107,1.76e107,1e105);
...
CREATE TABLE `normal_user` (
  ...
  `point` int DEFAULT '0',
  PRIMARY KEY (`user_id`),
  CONSTRAINT `normal_user_user_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `normal_user` VALUES (10,1,1,1,0,NULL,NULL,0),(11,1,1,1,0,NULL,NULL,0),(12,1,1,1,0,NULL,NULL,0),(13,1,1,1,0,NULL,NULL,0),(14,1,1,1,0,NULL,NULL,0),(15,123,123,13,0,NULL,NULL,0),(16,1,1,1,NULL,0,1.2,0),(17,1,1,1,1,0,1.2,0),(18,1,1,1,0,0,1.2,0),(19,50.3,14,160,0,0,1.2,0),(22,6,6,6,0,0,1.2,0),(24,1,1,1,0,0,1.2,0);
...
CREATE TABLE `notification` (
  ...
  CONSTRAINT `notification_user_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `notification` VALUES (1,'您的账号已被管理员封禁',0,17,1,'2025-01-03 18:06:55'),(2,'您的帖子(标题:test)已被标记为违规',0,18,1,'2025-01-03 18:11:21'),(3,'您的评论(内容:test)已被标记为违规',0,16,1,'2025-01-03 18:15:28'),(4,'您的评论(内容:test)已被取消违规标记',0,16,1,'2025-01-03 18:17:52'),(5,'该吃早餐啦！',1,22,1,'2025-01-03 21:05:49'),(6,'该吃午餐啦！',1,22,1,'2025-01-03 21:05:49'),(7,'该吃晚餐啦！',1,22,1,'2025-01-03 21:05:49'),(8,'该喝水啦！',1,22,2,'2025-01-03 21:05:49'),(9,'该喝水啦！',1,22,2,'2025-01-03 21:37:36'),(10,'该吃晚餐啦！',1,22,1,'2025-01-03 21:44:28'),(11,'该喝水啦！',1,22,2,'2025-01-03 21:44:28'),(12,'该吃早餐啦！',1,22,1,'2025-01-03 21:44:44'),(13,'该吃午餐啦！',1,22,1,'2025-01-03 21:44:44'),(14,'该吃晚餐啦！',1,22,1,'2025-01-03 21:44:44'),(15,'该喝水啦！',1,22,2,'2025-01-03 21:44:44'),(16,'该喝水啦！',1,22,2,'2025-01-03 22:04:42'),(17,'该喝水啦！',1,22,2,'2025-01-03 22:08:43'),(18,'该喝水啦！',1,22,2,'2025-01-03 22:17:24'),(19,'该吃晚餐啦！',1,22,1,'2025-01-03 22:24:08'),(20,'该喝水啦！',1,22,2,'2025-01-03 22:26:03'),(21,'您的账号已被管理员封禁',0,22,1,'2025-01-04 13:25:36'),(22,'您的账号已被管理员解封',0,22,1,'2025-01-04 13:27:08');
...
INSERT INTO `post` VALUES (1,'test',18,'test','test','2024-12-31 00:00:00',1),(2,'test',18,'test','test','2024-12-31 23:06:39',0),(3,'公告',21,'1','公告','2025-01-03 23:51:42',0);
...
INSERT INTO `user` VALUES (6,'a','f707fdda7c874ff49ebfb2c88a2860c5ff4ce3d94a21efb76566ad0f92c9ad57','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'12345678909'),(7,'1','f707fdda7c874ff49ebfb2c88a2860c5ff4ce3d94a21efb76566ad0f92c9ad57','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'1'),(9,'q','f707fdda7c874ff49ebfb2c88a2860c5ff4ce3d94a21efb76566ad0f92c9ad57','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'2'),(10,'q','f707fdda7c874ff49ebfb2c88a2860c5ff4ce3d94a21efb76566ad0f92c9ad57','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'3'),(11,'q','f707fdda7c874ff49ebfb2c88a2860c5ff4ce3d94a21efb76566ad0f92c9ad57','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'4'),(12,'q','f707fdda7c874ff49ebfb2c88a2860c5ff4ce3d94a21efb76566ad0f92c9ad57','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'5'),(13,'z','f707fdda7c874ff49ebfb2c88a2860c5ff4ce3d94a21efb76566ad0f92c9ad57','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'6'),(14,'q','202a1e89d0dcd71985877aef8dde80819c52252857c201a70c39be4365506dbd','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'8'),(15,'123123','6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'12'),(16,'111','111',NULL,0,'111'),(17,'111','111',NULL,0,'1112'),(18,'111','111','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'1113'),(19,'V','3','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'333'),(21,'admin','1',NULL,1,'987654'),(22,'6','f707fdda7c874ff49ebfb2c88a2860c5ff4ce3d94a21efb76566ad0f92c9ad57','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'666'),(24,'111','222','https://img1.baidu.com/it/u=534429813,2995452219&fm=253&fmt=auto?w=800&h=800',0,'222');
...
CREATE TABLE `weight` (
  ...
  CONSTRAINT `weight_user_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `weight` VALUES (16,53,'2025-01-03 21:32:55'),(19,50.3,'2025-01-02 21:28:47'),(22,6,'2025-01-03 19:43:40'),(24,1,'2025-06-15 15:18:58');
...
-- Dump completed on 2025-06-17 22:14:45
