...
INSERT INTO `normal_user` VALUES (10,1,1,1,0,NULL,NULL),(11,1,1,1,0,NULL,NULL),(12,1,1,1,0,NULL,NULL),(13,1,1,1,0,NULL,NULL),(14,1,1,1,0,NULL,NULL),(15,123,123,13,0,NULL,NULL),(16,1,1,1,NULL,0,1.2),(17,1,1,1,NULL,0,1.2),(18,1,1,1,0,0,1.2),(19,50.3,14,160,0,0,1.2);
...
INSERT INTO `post` VALUES (1,'test',18,'test','test','2024-12-31 00:00:00',0),(2,'test',18,'test','test','2024-12-31 23:06:39',0);
...
CREATE TABLE `recipe` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `recipe_user_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reminder` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `reminder_user_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `weight` VALUES (19,50.3,'2025-01-02 21:28:47');
...
-- Dump completed on 2025-01-02 21:29:56
